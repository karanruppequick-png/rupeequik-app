...
export default function HomeLoanPage() {
  ...
  useEffect(() => {
    async function fetchOffers() {
      try {
        const res = await fetch('/api/offers?category=home-loan');
  ...
  const handleApply = () => {
    ...
    setError('');
    router.push(`/apply?category=home-loan&phone=${mobileNumber}&pan=${pan.toUpperCase()}`);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      {/* Hero Section specifically for Home Loan */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl py-10 lg:pr-10">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-bold text-[#1C295E] leading-[1.1] tracking-tight mb-8">
                Find the Best <br />
                <span className="text-[#4A69FF]">Home Loan</span> Offers with Low <br />
                Interest Rates
              </h1>

              <div className="flex flex-col gap-6 mb-12 relative">
                {/* Temporary reuse of hero_man graphic until the family house graphic is uploaded */}
                <Image src="/hero_man.png" alt="Happy User" width={300} height={300} className="rounded-2xl shrink-0 drop-shadow-xl" />
                <div className="absolute bottom-10 right-20 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-3 flex items-center gap-3">
                  ...
                  <p className="text-xs font-bold text-[#1C295E] pr-2">Paperless Application Process <span className="block text-[10px] text-slate-500 font-normal">Apply From anywhere</span></p>
                </div>
              </div>
             ...
             <div className="bg-white rounded-[2rem] p-8 w-full max-w-[440px] shadow-[0_20px_60px_rgb(0,0,0,0.15)] border border-white/20">
               <div className="text-center mb-8">
                 <h2 className="text-[22px] font-bold text-[#1C295E]">
                   Get up to <span className="text-[#4A69FF]">₹2 Crore</span> starting at <span className="bg-blue-50 text-[#4A69FF] px-2 py-0.5 rounded ml-1">8.75%</span>
                 </h2>
               </div>

               <div className="space-y-6">
                 <div>
                   <label className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 block">Applicant Name</label>
                   <input
                     type="text"
                     value={fullName}
      ...
      <section className="py-4 overflow-hidden border-y border-[#E8ECFF] bg-[#F8FAFC]">
        <div className="flex animate-marquee whitespace-nowrap">
          {[
             '78+ Bank Partners', 'Wide Range of Options', 'Free Credit Score Check', 
             'Reward on payments', 'Quick Assistance', 'Rate Trend Updates', 'Easy Loan Access'
          ].map((item, i) => (
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#1C295E]">Explore Top Home Loan Options</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:w-[70%] space-y-8">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-black text-[#1C295E]">Home Loan Offers</h2>
            ...
            <div className="space-y-8 sticky top-28">
              ...
              <div className="bg-[#1C295E] rounded-3xl p-8 text-white relative overflow-hidden">
                 <h3 className="text-[22px] font-bold leading-tight mb-2 relative z-10">What&apos;s the Online Home Loan<br />Application Process?</h3>
              ...
              <div className="bg-[#EAF0FC] rounded-3xl p-8 relative overflow-hidden min-h-[350px] flex flex-col border border-blue-50 shadow-sm">
                <div className="relative z-10 mb-8 max-w-[80%]">
                  <h3 className="text-3xl font-black text-[#1C295E] leading-[1.1] mb-2 tracking-tight">Apna ghar,</h3>
                  <h3 className="text-3xl font-black text-[#4A69FF] leading-[1.1] tracking-tight">ab bas ek kadam door.</h3>
                </div>
              ...
              <div className="bg-[#4A69FF] rounded-3xl p-8 text-white relative overflow-hidden shadow-lg shadow-blue-500/20">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="text-[15px] font-medium leading-snug">Compare & Disburse the <span className="font-bold text-orange-200">Best Offer</span></p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-white mt-2 shrink-0 opacity-80" />
      ...
      <div className="bg-white border-y border-slate-100 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex items-center gap-2 text-xs font-medium">
             ...
             <span className="text-slate-500">Home Loan Application</span>
           </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-[0_10px_40px_rgb(0,0,0,0.03)] overflow-hidden">
            <div className="flex flex-col lg:flex-row">
               ...
               <div className="lg:w-[60%] p-8 lg:p-12">
                 <h2 className="text-[28px] font-bold text-[#1C295E] mb-8">Calculate Your Home Loan EMI</h2>
                 ...
                 <div className="bg-slate-50 rounded-2xl p-6 lg:p-8 border border-slate-200/60 space-y-10">
                    ...
                    <div>
                      ...
                      <input type="range" min={50000} max={50000000} step={100000} value={emiAmount} onChange={e => setEmiAmount(Number(e.target.value))} className="w-full h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#4A69FF]" />
                      <div className="flex justify-between text-[11px] font-bold text-slate-400 mt-2"><span>1L</span><span>5Cr</span></div>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <input type="range" min={1} max={emiTenureType === 'Yr' ? 30 : 360} step={1} value={emiTenure} onChange={e => setEmiTenure(Number(e.target.value))} className="w-full h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#4A69FF]" />
                        <div className="flex justify-between text-[11px] font-bold text-slate-400 mt-2"><span>1{emiTenureType}</span><span>{emiTenureType === 'Yr' ? '30Y' : '360M'}</span></div>
                      </div>
                    </div>
                 </div>
               </div>
